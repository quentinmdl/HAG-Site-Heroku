 ...
 */
final class Version20210515172517 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, category INT DEFAULT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, file VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_23A0E66989D9B62 (slug), INDEX IDX_23A0E6664C19C1 (category), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_general_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE challenge (id INT AUTO_INCREMENT NOT NULL, session_id INT NOT NULL, name VARCHAR(50) NOT NULL, slug VARCHAR(255) NOT NULL, file VARCHAR(255) DEFAULT NULL, description LONGTEXT NOT NULL, location VARCHAR(255) NOT NULL, point INT NOT NULL, progession INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_D7098951989D9B62 (slug), INDEX IDX_D7098951613FECDF (session_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_general_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `group` (id INT AUTO_INCREMENT NOT NULL, session_id INT NOT NULL, name VARCHAR(30) NOT NULL, owner VARCHAR(50) NOT NULL, slug VARCHAR(255) NOT NULL, state LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', score INT NOT NULL, token VARCHAR(10) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_6DC044C5989D9B62 (slug), INDEX IDX_6DC044C5613FECDF (session_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_general_ci` ENGINE = InnoDB');
